        ...
        <div className="flex flex-1 overflow-hidden relative z-10">
          ...
          <main
            className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 w-full ${
              sidebarCollapsed ? "sm:pl-20 pl-1 pr-1 pt-1 pb-16 sm:pb-4" : "sm:pl-68 pl-1 pr-1 pt-1 pb-16 sm:pb-4"
            }`}
          >
            ...
            <section className="positions-container flex-1 min-h-0 max-h-[50vh] sm:max-h-none relative p-2 rounded-xl">
              
              <div className="relative z-10 h-full rounded-xl overflow-hidden m-2">
                <div className="trading-card-override relative z-10 h-full rounded-xl overflow-hidden">
