    ...
    <Card className="h-full bg-gradient-to-br from-gray-800/40 to-black/60 border-2 border-gray-600/40 backdrop-blur-sm"
      ...
      <CardContent className="p-0 bg-gradient-to-br from-gray-700/20 to-black/40 h-full">
        <Tabs defaultValue="open" className="h-full flex flex-col">
          ...
          <TabsContent value="open" className="mt-0 flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-gray-800/10 to-black/20">
            {isLoading && positions.length === 0 ? (
              ...
              <>
                ...
                <div className="sm:hidden p-2 space-y-2 flex-1 overflow-auto">
                ...
                <div className="hidden sm:block flex-1 overflow-auto bg-gradient-to-br from-gray-800/10 to-black/20 rounded-lg">
