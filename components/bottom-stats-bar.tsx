...
export default function BottomStatsBar() {
  ...
  return (
    <div className="fixed left-0 right-0 sm:bottom-0 bottom-14 bg-gradient-to-r from-gray-900/95 via-black/90 to-gray-800/95 backdrop-blur-xl border-t border-gray-700/50 z-[10] py-2 shadow-2xl"
         style={{
