    ...
    <>
      <div
        className={cn(
          ...
          "hidden sm:flex flex-col border-r transition-all duration-300 fixed top-16 left-0 h-[calc(100vh-4rem)] z-40",
          // Attractive gradient background with glassmorphism and 3D effect
        ...
        style={{
          boxShadow: "inset 1px 1px 2px rgba(255,255,255,0.1), inset -1px -1px 2px rgba(0,0,0,0.5), 0 20px 40px rgba(0,0,0,0.3)"
        }}
      >
      {/* Header */}
      ...
      {/* Navigation - Enhanced styling with 3D effects */}
          ...
          {sidebarItems.map((item) => {
            ...
            return (
              <Link
                ...
                style={isActive ? {
                  boxShadow: "inset 2px 2px 4px rgba(0,0,0,0.5), inset -1px -1px 2px rgba(255,255,255,0.1), 0 4px 8px rgba(0,0,0,0.3)"
                } : {}}
              >
                ...
                {!collapsed && (
                  <span className="relative z-10 transition-all duration-200 drop-shadow-sm">
                    {item.title}
                  </span>
                )}
                ...
                {isActive && (
                  <div className="absolute right-2 w-2 h-2 bg-gray-300 rounded-full animate-pulse shadow-inner"
                       style={{
                         boxShadow: "inset 1px 1px 2px rgba(0,0,0,0.5), 0 1px 2px rgba(255,255,255,0.3)"
                       }} />
                )}
              </Link>
            )
        ...
        <div className="p-4 border-t border-gray-700/30 bg-gradient-to-r from-gray-800/30 to-black/20 relative">
          ...
          <div className="text-xs text-gray-400 text-center space-y-2 relative z-10">
            <div className="flex items-center justify-center space-x-2">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-gray-600 to-black flex items-center justify-center shadow-inner"
                   style={{
            ...
            <div className="pt-2 border-t border-gray-700/20">
              <div className="flex items-center justify-center space-x-1">
                <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse shadow-lg"
                     style={{
                       boxShadow: "0 0 4px rgba(34, 197, 94, 0.5), inset 1px 1px 2px rgba(255,255,255,0.2)"
                     }}></div>
      ...
      {/* Mobile bottom navigation - enhanced styling with 3D effects */}
      <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-gradient-to-r from-gray-900/95 via-black/90 to-gray-800/95 backdrop-blur-xl border-t border-gray-700/50 sm:hidden shadow-2xl"
           style={{
             boxShadow: "inset 0 1px 2px rgba(255,255,255,0.1), 0 -10px 20px rgba(0,0,0,0.3)"
           }}>
        <nav className="flex items-center justify-between h-14 px-1">
          ...
          {/* Profile / More menu - enhanced styling with 3D effects */}
          <div className="flex-1 flex items-center justify-center">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex flex-col items-center justify-center py-2 px-3 text-xs transition-all duration-200 hover:bg-gradient-to-t hover:from-gray-700/30 hover:to-gray-600/20 rounded-lg group"
                        style={{
                          boxShadow: "1px 1px 2px rgba(0,0,0,0.2)"
                        }}>
                  <Avatar className="h-6 w-6 ring-2 ring-gray-600 group-hover:ring-gray-400 transition-all duration-200 shadow-md"
                          style={{
                            boxShadow: "2px 2px 4px rgba(0,0,0,0.3), inset 1px 1px 2px rgba(255,255,255,0.1)"
                          }}>
              ...
              <DropdownMenuContent align="center" className="w-48 bg-gray-800/95 border-gray-700/50 backdrop-blur-xl shadow-2xl"
                                   style={{
                                     boxShadow: "0 20px 40px rgba(0,0,0,0.5), inset 1px 1px 2px rgba(255,255,255,0.1)"
                                   }}>
                {mobileMore.map((it) => (
